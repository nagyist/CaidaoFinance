...
typedef NS_ENUM(NSInteger, FUIAlertViewButtonLayoutStyle) {
    FUIAlertViewButtonLayoutVertical = 0,
    FUIAlertViewButtonLayoutHorizontal
};
...
@property(nonatomic,assign) FUIAlertViewButtonLayoutStyle alertButtonStyle;
