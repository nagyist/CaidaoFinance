...
- (void)didScrollToPosition:(CGPoint)position {
    ...
    if ([__delegate respondsToSelector:@selector(pageScrollViewDidScrollToPage:)]) {
        [__delegate pageScrollViewDidScrollToPage:self.currentPage];
    }
}
...
{
    if ([__delegate respondsToSelector:@selector(pageScrollViewDidSelected:)]) {
        [__delegate pageScrollViewDidSelected:self.currentPage];
    }
}
